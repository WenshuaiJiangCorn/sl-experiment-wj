...
if __name__ == "__main__":
    ...
    vs = VideoSystem(
        ...
        frame_width = 1920,
        frame_height = 1080,  # Displays the acquired data at a rete of 15 frames per second
    ...
    timer.delay(delay=10, block=False)  # Records frames for 10 seconds, generating ~150 frames

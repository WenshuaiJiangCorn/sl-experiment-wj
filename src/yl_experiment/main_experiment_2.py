...
EXPERIMENT_DIR = Path(
    "C:\\Users\\yapici\\Dropbox\\Research_projects\\dopamine\\mazes\\linear_track\\10_percecnt_sucrose\\2026Feb_DAT\\raw_data"
    )
...
def run_experiment() -> None:
    ...
    try:
        ...
        valve_delay_active = False  # Flag to track if we're in delay period
        valve_triggered_side = None  # Track which side triggered the delay

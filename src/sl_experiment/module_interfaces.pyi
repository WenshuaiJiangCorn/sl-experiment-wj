...
class EncoderInterface(ModuleInterface):
    ...
    def distance_tracker(self) -> SharedMemoryArray:
        ...
        """
    @staticmethod
    def parse_logged_data(log_path: Path, output_directory: Path, cm_per_pulse: np.float64) -> None:
...
class BreakInterface(ModuleInterface):
    ...
    def parse_logged_data(
        log_path: Path, output_directory: Path, maximum_break_strength: np.float64, minimum_break_strength: np.float64
    ) -> None:
        """Extracts and saves the data acquired by the break module during runtime as a .feather file.
...
class LickInterface(ModuleInterface):
    ...
    def lick_tracker(self) -> SharedMemoryArray:
        ...
        """
    @staticmethod
    def parse_logged_data(log_path: Path, output_directory: Path, lick_threshold: np.uint16) -> None:
        """Extracts and saves the data acquired by the break module during runtime as a .feather file.
...
class TorqueInterface(ModuleInterface):
    ...
    def force_per_adc_unit(self) -> np.float64:
        ...
        """
    @staticmethod
    def parse_logged_data(log_path: Path, output_directory: Path, torque_per_adc_unit: np.float64) -> None:
        """Extracts and saves the data acquired by the break module during runtime as a .feather file.
